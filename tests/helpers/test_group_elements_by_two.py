...
class TestGroupByTwo(unittest.TestCase):
    def test_group_elements_by_two(self):
        main_row = ['Bending Machine',	'<a href="https://www.topeintl.com/en/bending-machine.html" >Bending Machine</a>',	
    ...
    def test_when_odd_count_of_elements(self):
        ...
        self.assertIn('The list must has even count of elements.', str(cm.exception))
